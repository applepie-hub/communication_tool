...
// web客户端
    ...
    sendTdParameters = async () => {
        ...
        const wasmHost = [process.env.REACT_APP_HOST_C, process.env.REACT_APP_HOST_B, process.env.REACT_APP_HOST_A];
        // 
        ...
        this.send({
            ...
            parameters: {
                ...
                api_hash: apiHash,
                dc_host_idx: 0,
                dc_host_list: wasmHost,//['a.gochat8.com', 'b.gochat8.com', 'c.gochat8.com'],
